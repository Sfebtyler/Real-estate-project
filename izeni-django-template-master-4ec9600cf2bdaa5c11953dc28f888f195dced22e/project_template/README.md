...
- [![build status](https://dev.izeni.net/ci/projects/_TODO_/status.png?ref=master)](https://dev.izeni.net/ci/projects/_TODO_?ref=master) @ [master](https://dev.izeni.net/_TODO__PROJECT_GROUP__TODO_/{{project_name}}/blob/master/README.md)
- [![build status](https://dev.izeni.net/ci/projects/_TODO_/status.png?ref=develop)](https://dev.izeni.net/ci/projects/_TODO_?ref=develop) @ [develop](https://dev.izeni.net/_TODO__PROJECT_GROUP__TODO_/{{project_name}}/blob/develop/README.md)
...
1. Create the database:
    ...
    ```bash
    echo "CREATE USER {{ project_name }} WITH PASSWORD '{{ project_name }}'; CREATE DATABASE {{ project_name }} OWNER {{ project_name }}; ALTER USER {{ project_name }} CREATEDB;" | su postgres -c psql
    ```
...
```bash
su postgres -c "psql {{ project_name }}"
```

-or-

```bash
docker exec -it {{ project_name }}_database_1 su postgres -c "psql {{ project_name }}"
```
